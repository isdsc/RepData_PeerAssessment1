...
The results show that, using the `na.rm = TRUE` option introduces eight more
days with total step count of zero, which moves the mean (red vertical line)
and the median (blue vertical dashes) towards the left.
