...
```{r, message=FALSE, fig.width=7, fig.height=10.5}
# Compare histograms after imputing
...
# Create a function to plot the data with ggplot
# Since we are not using facets, manually force the same y scale
...
hist1 = plot_it2(step_by_date_impute[Method == "1. Original"]       , "..scaled..*4.35", "Original")
hist2 = plot_it2(step_by_date_impute[Method == "2. Impute: Overall"], "..scaled..*7.50", "Impute: Overall")
hist3 = plot_it2(step_by_date_impute[Method == "3. Impute: DOW"]    , "..scaled..*5.55", "Impute: DOW")
